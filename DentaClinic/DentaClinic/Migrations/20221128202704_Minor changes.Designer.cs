...
namespace DentaClinic.Migrations
{
    ...
    [Migration("20221128202704_Minor changes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DentaClinic.Models.FreeVisit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DentaClinic.Models.Service", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DentaClinic.Models.User", b =>
                {
            ...
            modelBuilder.Entity("DentaClinic.Models.FreeVisit", b =>
                {
                    b.HasOne("DentaClinic.Models.Service", "Service")
                        .WithMany()
                        .HasForeignKey("ServiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DentaClinic.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("DentaClinic.Models.Visit", b =>
                {
                    b.HasOne("DentaClinic.Models.FreeVisit", "FreeVisit")
                        .WithMany()
                        .HasForeignKey("FreeVisitId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DentaClinic.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
